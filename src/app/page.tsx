...
export default function Home() {
    return (
        <section className="text-center w-600 mx-auto">
            <div>
            ...
            <div className="mt-16">
                ...
                <div className="my-6 text-blue-500 text-center select-none">
            ...
            <div className="flex gap-2.5 w-full p-2.5 rounded-lg bg-slate-100 text-slate-400">
                ...
                <div className="text-left">
                    ...
                    <p className="text-[0.8rem] font-medium">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Optio tempore maxime facere est recusandae ullam necessitatibus doloremque minima laborum magni!</p>
                </div>
            </div>
        </section>
    );
