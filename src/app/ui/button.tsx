...
export default function Button({ children, classes, url, click }: Properties) {
    let classList = `bg-blue-600 text-white text-xs font-semibold pt-2.5 pb-2.5 pl-4 pr-4 rounded duration-150 hover:bg-blue-700 active:bg-blue-800${classes?.length ? " " + classes : ""}`;
