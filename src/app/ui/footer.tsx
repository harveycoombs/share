    ...
    return (
            <footer className="absolute bottom-0 left-0 right-0">
                <div className="flex justify-between items-center p-4 max-[460px]:p-3">
                    ...
                    <strong className="text-sm font-bold max-lg:text-xs"><Link href="/disclaimer" className="hover:underline">LEGAL DISCLAIMER</Link> &middot; <Link href="/takedowns" className="hover:underline">TAKEDOWN REQUESTS</Link></strong>
                </div>
            </footer>
    );
}