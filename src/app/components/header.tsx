    ...
    return (
        <>
            <header className="absolute top-0 left-0 right-0">
                <Banner><span>&#127881; Share 3.2.1 is here. Check out whats changed by clicking <Link href="https://github.com/harveycoombs/share/releases/tag/3.2.1" target="_blank" className="hover:underline">here</Link>.</span></Banner>
