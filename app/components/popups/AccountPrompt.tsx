...
export default function AccountPrompt({ onClose }: Properties) {
    return (
        <Popup title="Share Account" onClose={onClose}>
            <div className="w-80">
                <strong className="block text-center text-lg font-semibold">Get More out of Share</strong>

                <div className="font-medium text-sm text-center text-slate-400 mt-1 mb-10">Log in or create an account to access<br/>more features</div>
