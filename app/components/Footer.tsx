...
export default function Footer() {
    ...
    return (
        ...
        >
            <div className="p-2.5 border border-slate-300 rounded-2xl flex justify-between items-center text-slate-400 text-sm font-medium">
