...
export default function Footer() {
    return (
        <footer className="p-4 flex justify-between items-center select-none text-slate-400/60 dark:text-zinc-400 text-sm font-medium max-md:text-xs max-sm:flex-col max-sm:items-center max-sm:gap-2 dark:text-zinc-600">
