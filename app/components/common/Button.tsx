...
export default function Button({ children, url, small, classes, transparent, color = "bg-sky-500 hover:bg-sky-600 active:bg-sky-700", loading, disabled, ...rest }: Properties) {
