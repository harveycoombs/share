...
export default function Button({ children, url, small, classes, transparent, loading, disabled, ...rest }: Properties) {
    const appearance = transparent ? "font-semibold hover:bg-slate-50 hover:text-slate-500 active:bg-slate-100 active:text-slate-600 dark:hover:bg-zinc-800/60 dark:active:bg-zinc-800/90 dark:hover:text-zinc-400 dark:active:text-zinc-400" : "font-medium bg-blue-500 text-white hover:bg-blue-600 active:bg-blue-700";
