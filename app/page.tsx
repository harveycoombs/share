...
export default function Home() {
    ...
    return (
        <main className="min-h-[calc(100vh-112px)] grid place-items-center" onDragOver={handleDragOverEvent} onDragEnter={handleDragEnterEvent} onDragLeave={handleDragLeaveEvent} onDrop={handleDropEvent}>
            <motion.section
